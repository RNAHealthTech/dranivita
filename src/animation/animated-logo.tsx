...
export default function AnimatedLogo({ color = "#111111" }: AnimatedLogoProps) {
  ...
  return (
    <AnimatePresence>
      <motion.svg
        width="211.25"
        height="50.07492676264086"
        viewBox="0 0 370.056338028169 87.71855159674145"
      ...
      >
        ...
        <motion.g id="SvgjsG1014"
          transform="matrix(1.0560469403141322,0,0,1.0560469403141322,-15.829934918756193,-8.943471045898912)"
          fill={color}
          initial={{ fill: color }}
          animate={{ fill: color }}
        ...
        >
          ...
          <motion.path
            ...
            xmlns="http://www.w3.org/2000/svg"
            d="M51.568,75.274c0.001-0.228,0.019-0.455,0.034-0.683c0.014-0.214,0.105-0.365,0.254-0.505  c0.269-0.253,0.516-0.525,0.725-0.834c0.443-0.655,0.473-1.333,0.148-2.039c-0.178-0.388-0.424-0.735-0.705-1.052  c-0.777-0.876-1.686-1.594-2.668-2.226c-0.803-0.517-1.659-0.95-2.419-1.535c-1.094-0.841-2.058-1.801-2.776-2.99  c-0.582-0.965-0.953-1.994-0.949-3.139c0.003-0.916,0.263-1.755,0.737-2.531c0.488-0.799,1.137-1.448,1.88-2.01  c0.144-0.109,0.27-0.142,0.447-0.068c0.521,0.216,1.05,0.414,1.577,0.618c0.292,0.113,0.293,0.141,0.325,0.449  c0.038,0.363-0.108,0.575-0.418,0.759c-0.591,0.352-1.105,0.803-1.519,1.36c-0.714,0.96-0.801,1.988-0.332,3.075  c0.222,0.514,0.537,0.97,0.912,1.381c0.676,0.74,1.423,1.4,2.238,1.985c0.831,0.595,1.7,1.129,2.573,1.659  c1.041,0.632,1.959,1.403,2.64,2.428c0.442,0.666,0.703,1.402,0.73,2.199c0.018,0.533-0.099,1.057-0.289,1.56  c-0.189,0.502-0.462,0.956-0.778,1.387c-0.472,0.643-1.034,1.199-1.651,1.7c-0.227,0.184-0.241,0.167-0.465-0.024  c-0.191-0.162-0.279-0.351-0.254-0.6C51.577,75.492,51.568,75.383,51.568,75.274z"></motion.path>
          <motion.path
            strokeWidth="15"
            variants={iconVariant}
            initial="hidden"
          ...
          <motion.path
            ...
            xmlns="http://www.w3.org/2000/svg"
            d="M51.108,58.333c-0.1,1.809-0.033,3.633-0.076,5.454c-0.012,0.531-0.036,1.062-0.047,1.593  c-0.005,0.266-0.047,0.284-0.282,0.144c-0.523-0.311-1.009-0.677-1.505-1.027c-0.193-0.136-0.243-0.31-0.243-0.531  c0.002-0.955,0.019-1.911-0.013-2.864c-0.044-1.312-0.053-2.624-0.057-3.937c-0.001-0.524,0.003-0.527,0.503-0.326  c0.453,0.182,0.896,0.387,1.34,0.589c0.289,0.132,0.419,0.32,0.38,0.632C51.098,58.147,51.108,58.235,51.108,58.333z"></motion.path>
          <motion.path
            strokeWidth="15"
            variants={iconVariant}
            initial="hidden"
          ...
          <motion.path
            ...
            xmlns="http://www.w3.org/2000/svg"
            d="M50.91,72.372c0,0.575,0.006,1.151-0.002,1.726c-0.005,0.336-0.028,0.672-0.051,1.007c-0.014,0.199-0.08,0.233-0.246,0.103  c-0.47-0.368-0.929-0.75-1.394-1.123c-0.139-0.112-0.132-0.264-0.133-0.416c-0.002-0.738,0.012-1.477-0.01-2.215  c-0.024-0.792-0.056-1.583-0.052-2.375c0-0.054-0.002-0.109,0-0.163c0.009-0.27,0.051-0.295,0.278-0.144  c0.497,0.332,0.972,0.692,1.416,1.094c0.149,0.134,0.212,0.286,0.21,0.486c-0.007,0.673-0.003,1.346-0.003,2.019  C50.919,72.372,50.915,72.372,50.91,72.372z"></motion.path>
          <motion.path
            strokeWidth="15"
            variants={iconVariant}
            initial="hidden"
            ...
            xmlns="http://www.w3.org/2000/svg"
            d="M50.729,86.306c-0.132-0.016-0.157-0.081-0.187-0.136c-0.574-1.053-1.081-2.132-1.289-3.327  c-0.017-0.096-0.035-0.193-0.04-0.29c-0.062-1.302-0.063-2.605-0.066-3.908c0-0.011-0.001-0.022,0-0.033  c0.013-0.081-0.03-0.191,0.076-0.227c0.081-0.028,0.133,0.055,0.192,0.1c0.74,0.557,1.142,1.319,1.341,2.205  c0.036,0.161,0.036,0.323,0.035,0.486c-0.004,1.271-0.009,2.542-0.012,3.813C50.779,85.423,50.707,85.853,50.729,86.306z"></motion.path>
          <motion.path
            strokeWidth="15"
            variants={iconVariant}
            initial="hidden"
            ...
            xmlns="http://www.w3.org/2000/svg"
            d="M49.319,88.089c0.243,0.126,0.381,0.327,0.568,0.468c0.233,0.175,0.447,0.376,0.672,0.563  c0.079,0.065,0.141,0.132,0.131,0.244c-0.049,0.594-0.101,1.188-0.327,1.749c-0.073,0.18-0.138,0.402-0.362,0.418  c-0.243,0.018-0.287-0.228-0.375-0.393c-0.097-0.183-0.143-0.385-0.184-0.587c-0.158-0.768-0.188-1.546-0.162-2.327  C49.281,88.192,49.297,88.161,49.319,88.089z"></motion.path>
        </motion.g>
      </motion.svg>
    </AnimatePresence>
  );
