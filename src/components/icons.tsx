...
export const FacebookIcon = (props: IconType) => (
  <svg
    stroke="currentColor"
    fill="currentColor"
    strokeWidth="0"
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M12 0C5.373 0 0 5.373 0 12c0 5.999 4.375 10.978 10.125 11.875v-8.375H7.25V12h2.875V9.625c0-2.875 1.75-4.625 4.5-4.625 1.25 0 2.375.125 2.75.125v3h-1.5c-1.5 0-2 1-2 2v2h3.875l-.625 3.875h-3.25V24C19.625 23.375 24 18.375 24 12c0-6.627-5.373-12-12-12z"
    />
  </svg>
);
